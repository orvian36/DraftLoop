...
| 6 | `2026-05-15-06-evaluation-plan.md`            | `draftloop_eval` — Ragas + HHEM + golden corpus + scorecard (Phase 06 spec) | Plans 3, 5 | **DONE** (merged 2026-05-16) |
| 7 | `2026-05-15-07-composition-demo-plan.md`      | `apps/api` full wiring, seed/demo scripts, Docker compose, README + eval report | All prior | **DONE** (merged 2026-05-16) |
