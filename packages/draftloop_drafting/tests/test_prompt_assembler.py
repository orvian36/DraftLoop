...
def test_assembler_renders_principles_and_exemplars():
    ...
    system, _ = asm.render(
        matter_id="M-1",
        retrieval_hits={"claims": [_hit("c1")]},
        fact_exemplars=[{"induced_rule": "Use ISO dates", "before_text": "March 14, 2024", "after_text": "2024-03-14"}],
        style_exemplars=[{"induced_rule": "Formal voice", "before_text": "Plaintiff said", "after_text": "Plaintiff alleges"}],
...
def test_assembler_dedupes_chunks_across_slots():
    ...
    system, _ = asm.render(
        ...
        fact_exemplars=[], style_exemplars=[], principles=[],
    )
